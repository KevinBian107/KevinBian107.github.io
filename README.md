...
<div style="text-align: center;">
    <img src="assets/vnl.png" alt="imitation pipeline" style="width:80%; height:auto;">
</div>

*MoCap registration + Generalized virtual bodies (borrowed from Talmo's Lab VNL slides)*
